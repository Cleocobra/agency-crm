        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-surface border border-border w-full max-w-lg rounded-xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-textMuted mb-1">Início do Contrato</label>
                            <input
                                type="date"
                                required
                                value={startDate}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-textMuted mb-1">Duração (Meses)</label>
                            <input
                                type="number"
                                min="1"
                                required
                    ...
                    <div>
                        <label className="block text-sm font-medium text-textMuted mb-1">Valor Mensal (R$)</label>
                        <input
                            type="number"
                            min="0"
                            step="0.01"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-textMuted mb-1">Contrato</label>
                        <div className="space-y-3">
                            <div className="flex items-center justify-center w-full">
                                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-border rounded-lg cursor-pointer bg-surface hover:bg-background transition-colors">
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        <svg className="w-8 h-8 mb-4 text-textMuted" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                                        </svg>
                                        <p className="text-sm text-textMuted"><span className="font-semibold">Clique para enviar</span> ou arraste</p>
                                        <p className="text-xs text-textMuted">PDF, DOC, Imagens (MAX. 5MB)</p>
                                    </div>
                                    <input
                                        id="dropzone-file"
                                        type="file"
                            ...
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-xs uppercase">
                                    <span className="bg-surface px-2 text-textMuted">Ou link externo</span>
                                </div>
                            </div>
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <label htmlFor="prepaid" className="text-sm font-medium text-textMuted">
