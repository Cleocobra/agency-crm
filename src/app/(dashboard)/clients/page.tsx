            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                ...
                <div className="relative w-full md:w-auto">
                    ...
                    <input
                        ...
                        className="pl-10 pr-4 py-2 bg-surface border border-border rounded-lg text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary w-full md:w-64 transition-all"
                    />
                </div>
            </div>
